...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="fontawesome-free-5.6.3-web/css/fontawesome.min.css">
        <!-- main css -->
					...
					<div class="container">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								...
								<li class="nav-item active"><a class="nav-link" href="users.php">EDIT PROFILE</a></li> 
